...
import { CategoryBD, Product, ProductImage as ProductWithImage } from "@/interfaces";
...
export const ProductForm = ({ product, categories }: Props) => {
    ...
    watch('sizes'); // Si cambia se reenderiza el formulario
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        {
                            product.ProductImage?.map(image => (
                                <div key={image.id}>
                                    ...
                                    className="btn-danger rounded-b-xl w-full cursor-pointer">Eliminar</button>
                                </div>
                            ))
                        }
                    </div>
